            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input type="number" step="0.01" name="stock_quantity" id="stock_quantity" value="{{ old('stock_quantity', $yarn->stock_quantity) }}" class="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5" required>
                </div>
