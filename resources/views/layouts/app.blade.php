        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
                ...
                @if(in_array(Auth::user()->role, ['manager', 'supervisor']))
                    ...
                    {{-- Kelola Instruksi (ONLY MANAGER) --}}
                    @if(Auth::user()->role === 'manager')
                    <a href="{{ route('instructions.index') }}" class="flex items-center p-3 text-sm font-medium rounded-r-lg transition-all duration-200 {{ request()->routeIs('instructions.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
