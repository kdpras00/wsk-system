...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        <div class="p-6 sm:p-8 bg-slate-50 border-b border-slate-100">
            <h3 class="text-xl font-bold text-slate-800">Formulir User Baru</h3>
            <p class="text-sm text-slate-500 mt-1">Lengkapi data di bawah ini untuk menambahkan user baru.</p>
        </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" required class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all" placeholder="Masukkan nama lengkap">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email" required class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all" placeholder="nama@perusahaan.com">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" id="password" required class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all" placeholder="••••••••">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select name="role" id="role" class="block w-full pl-10 pr-10 py-2.5 border border-slate-300 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all appearance-none bg-white">
                        <option value="operator">Operator - Staff Produksi</option>
                        <option value="manager">Manager - Approval & Laporan</option>
